...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        $stmt = $pdo->prepare("SELECT * FROM users WHERE email = ? AND role = 'citizen'");
        $stmt->execute([$email]);
        $user = $stmt->fetch();
...
<head>
    ...
    <title>Citizen Login - Civic Issue System</title>
                ...
                <div class="login-card bg-white">
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            <h3 class="text-primary">Citizen Portal</h3>
                            <p class="text-muted">Login to report and track civic issues</p>
                        </div>
                        ...
                        <p class="text-center mb-0">
                            New user? <a href="register.php" class="text-primary fw-bold">Register here</a>
                        </p>
